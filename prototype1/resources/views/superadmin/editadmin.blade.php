<html>
  ...
  <table border="0">
    ...
    <tr>
      <td>Username</td>
      <td><input type="text" name="uname" value="{{$new['username']}}"></td>
    </tr>
    <tr>
      <td>Name: </td>
      <td><input type="text" name="name" value="{{$new['name']}}"></td>
    </tr>
    <tr>
      <td>Email: </td>
      <td><input type="text" name="email" value="{{$new['email']}}"></td>
    </tr>
    <tr>
      <td>Phone: </td>
      <td><input type="text" name="phone" value="{{$new['phone']}}"></td>
    </tr>
    <tr>
      <td></td>
